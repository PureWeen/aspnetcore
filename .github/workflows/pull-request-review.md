...
independence, validation, retries, disclosure, and result formatting. The workflow instructions
below adapt that contract to this hosted trigger and staged safe-output channel; they do not replace
the skill.
