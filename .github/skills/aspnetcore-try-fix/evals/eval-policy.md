...
suite, not a reviewer-only generated byproduct. Its canonical cases live in
`evals.json`; its checked-in execution spec is
...
pwsh .github/skills/aspnetcore-pr-review/scripts/Validate-Evals.ps1 `
  -Path .github/skills/aspnetcore-try-fix/evals/evals.json
